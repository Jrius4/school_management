...
<div class="col">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group {{ $errors->has('service_category_id') ? 'has-error' : '' }}">
                {!! Form::select('service_category_id', App\ServiceCategory::pluck('title', 'id'), null, ['class' => 'form-control', 'placeholder' => 'Choose category']) !!}
            ...
            <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                  <div class="justify-content-center fileinput-new thumbnail" style="width: 200px; height: 150px;">
                    <img src="{{ ($service->image_thumb_url) ? $service->image_thumb_url : 'http://placehold.it/200x150&text=No+Image' }}" alt="...">
                  </div>
    ...
    <div class="card">
        <div class="card-footer">
            <button type="submit" class="btn btn-primary">{{ $service->exists ? 'Update' : 'Save' }}</button>
            <a href="{{ route('backend.services.index') }}" class="btn btn-default">Cancel</a>
        </div>
    </div>
