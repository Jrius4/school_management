        ...
        @foreach($processes as $process)
            ...
            <tr>
                <td>
                    {!! Form::open(['style' => 'display:inline-block;', 'method' => 'PUT', 'route' => ['backend.system-processes.restore', $process->id]]) !!}
                    ...
                    {!! Form::open(['style' => 'display:inline-block;', 'method' => 'DELETE', 'route' => ['backend.system-processes.force-destroy', $process->id]]) !!}
