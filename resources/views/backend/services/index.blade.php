            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="row d-flex justify-content-between">
                    <div class="mr-auto">
                        <a href="{{ route('backend.services.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
                    </div>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @else
                        @if($onlyTrashed)
                            @include('backend.services.table-trash')
                        @else
              ...
              <div class="card card-footer">
                    <div class="box-footer clearfix">
                        ...
                        <div class="pull-right">
                            <small>{{ $serviceCount }} {{ str_plural('Item', $serviceCount) }}</small>
                        </div>
                    </div>
              </div>
            </div>
