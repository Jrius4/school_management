...
<div class="col">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group {{ $errors->has('project_category_id') ? 'has-error' : '' }}">
                {!! Form::select('project_category_id', App\ProjectCategory::pluck('title', 'id'), null, ['class' => 'form-control', 'placeholder' => 'Choose category']) !!}
            ...
            <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                  <div class="justify-content-center fileinput-new thumbnail" style="width: 200px; height: 150px;">
                    <img src="{{ ($project->image_thumb_url) ? $project->image_thumb_url : 'http://placehold.it/200x150&text=No+Image' }}" alt="...">
                  </div>
    ...
    <div class="card">
        <div class="card-footer">
            <button type="submit" class="btn btn-primary">{{ $project->exists ? 'Update' : 'Save' }}</button>
            <a href="{{ route('backend.projects.index') }}" class="btn btn-default">Cancel</a>
        </div>
    </div>
