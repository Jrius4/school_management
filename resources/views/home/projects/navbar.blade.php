    {{-- <!-- Top Bar --> --}}
          ...
          <nav class="navbar navbar-expand-lg px-lg-0 navbar-dark bg-primary main-navbar-blue sticky-top">
            <div class="container position-relative">
              {{-- <!-- Navbar Brand--> --}}
              <a href="{{url('/')}}" class="navbar-brand">

                <img class="logo-navbar" style="height:75px" src="{{asset('/img/logos/Ndebi Tech Logo.png')}}" alt="logo">
              ...
              <div id="navbarSupportedContent" class="collapse navbar-collapse">
                ...
                <div class="nav-item active"><a href="{{route('projects.index')}}" class="nav-link">Projects</a></div>
                ...
                <div class="nav-item"><a href="{{url('/careers')}}" class="nav-link">Careers</a></div>
                  ...
                  <div class="nav-item">
                    ...
                    <li class="list-inline-item">
                            ...
                            <button id="navbarCategory" class="nav-link text-center  btn btn-sm btn-unique btn-quote-white"
